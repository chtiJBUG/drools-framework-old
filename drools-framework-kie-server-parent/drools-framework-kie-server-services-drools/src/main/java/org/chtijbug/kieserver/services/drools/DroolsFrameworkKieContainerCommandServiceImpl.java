...
public class DroolsFrameworkKieContainerCommandServiceImpl extends KieContainerCommandServiceImpl {

    private static final Logger logger = LoggerFactory.getLogger(DroolsFrameworkKieContainerCommandServiceImpl.class);

    private DroolsFrameworkRulesExecutionService rulesExecutionService;

    public DroolsFrameworkKieContainerCommandServiceImpl(KieServerImpl kieServer, KieServerRegistry context, DroolsFrameworkRulesExecutionService rulesExecutionService) {
