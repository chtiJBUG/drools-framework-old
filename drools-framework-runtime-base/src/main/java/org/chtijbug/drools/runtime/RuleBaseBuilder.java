...
public class RuleBaseBuilder {
	 ...
	 * @return
	 */
	public static RuleBasePackage createGuvnorRuleBasePackage(String guvnor_url, String guvnor_packageName, String guvnor_username, String guvnor_password) {
		RuleBasePackage newRuleBasePackage = new RuleBaseSingleton();
		GuvnorDroolsResource gdr = new GuvnorDroolsResource(guvnor_url, guvnor_packageName, guvnor_username, guvnor_password);
	 ...
	 * @return
	 */
	public static RuleBasePackage createGuvnorRuleBasePackage(String guvnor_url, String guvnor_appName, String guvnor_packageName, String guvnor_username, String guvnor_password) {
		RuleBasePackage newRuleBasePackage = new RuleBaseSingleton();
		GuvnorDroolsResource gdr = new GuvnorDroolsResource(guvnor_url, guvnor_appName, guvnor_packageName, guvnor_username, guvnor_password);
		newRuleBasePackage.addDroolsResouce(gdr);
		newRuleBasePackage.createKBase();
		return newRuleBasePackage;
	}
