...
public class RuleBaseBuilder {
    ...
    public static RuleBasePackage createRuleBasePackage(String guvnor_url, String guvnor_packageName, String guvnor_packageVersion, String guvnor_username, String guvnor_password) {
        RuleBasePackage newRuleBasePackage = new RuleBaseSingleton(guvnor_url, guvnor_packageName, guvnor_packageVersion, guvnor_username, guvnor_password);
        return newRuleBasePackage;
