...
public class AfterVariableChangeChangedHistoryEvent extends ProcessHistoryEvent {
    ...
    public AfterVariableChangeChangedHistoryEvent(Long eventID, DroolsProcessObject droolsProcessObject, int ruleBaseId, int sessionId, DroolsJbpmVariableObject oldValue, DroolsJbpmVariableObject newValue) {
